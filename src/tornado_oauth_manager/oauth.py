from tornado_oauth_manager.models import Client
...
class SkeletonValidator(RequestValidator):
    ...
    def authenticate_client(self, request, *args, **kwargs):
        ...
        request.client.client_id = 1
        return True

    def authenticate_client_id(self, client_id, request, *args, **kwargs):
        # Don't allow public (non-authenticated) clients
        print 'verifying code {} in {}'.format(client_id, codes)
        return client_id in codes

    def validate_code(self, client_id, code, client, request, *args, **kwargs):
        # Validate the code belongs to the client. Add associated scopes,
        # state and user to request.scopes, request.state and request.user.
        print 'verifying code {} == {}'.format(codes[client_id], code)
        return codes[client_id] == code
